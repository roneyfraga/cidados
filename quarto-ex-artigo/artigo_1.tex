...
\hypersetup{
  ...
  pdfauthor={Roney Fraga Souza; José da Silva},
...
\title{\bf Título do artigo}
\author{
Roney Fraga Souza\thanks{The authors gratefully acknowledge \emph{please
remember to list all relevant funding sources in the unblinded
version}.}\\
Faculdade de Economia, Universidade Federal de Mato Grosso\\
and\\José da Silva\\
